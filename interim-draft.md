...
> [Labour market overview data tables, UK, December 2020: accessibility example (ODS, 664KB)](https://gss.civilservice.gov.uk/wp-content/uploads/2021/05/Labour-market-overview-UK-December-2020-accessible-example.ods)
...
Using letters to signify notes is fine as long as the key to what these letters mean is clearly laid out above the table in a cell in column A. This ensures a user is made aware of the key before coming to the table. However, you should not use superscript text as this can be difficult to see for users with low vision and screen reader software does not differentiate superscript text from non-superscript text. Superscript text could therefore be a fail of accessibility [guideline 3.1 Readable](https://www.w3.org/TR/WCAG21/#readable) 

You should not use symbols to signpost to notes (see the sub section 'Use of symbols'). As with superscript text, symbols can be difficult to see for some users and screen reader software often does not recognise symbols. Therefore the use of symbols may fail accessibility [guideline 3.1 Readable] and accessibility [success criterion 1.1.1 non text content](https://www.w3.org/TR/WCAG21/#non-text-content). 
